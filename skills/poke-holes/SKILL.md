...
- Not a code review (this operates on planning artifacts, not code — use the Code Review skill for code, which dispatches an adversarial code-review pass for the code equivalent of this skill's lens)
